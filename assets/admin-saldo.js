...
(function() {
	...
	function consultarSaldoFromApi() {
		return postAjax('cepcer_consultar_saldo', {
			_wpnonce: nonceSaldo
		}).then(function(resp) {
	...
	if (btnCredito) {
		btnCredito.addEventListener('click', function() {
			var valorInput = document.getElementById('cepcer_valor_credito');
			...
			postAjax('cepcer_adicionar_credito', {
			...
			if (qrcodeContainer) {
				...
				var copiaColaInput = document.getElementById('cepcer_copia_cola');
	...
	if (btnCopiar) {
		btnCopiar.addEventListener('click', function() {
			var input = document.getElementById('cepcer_copia_cola');

(function () {
	...
	document.addEventListener(
		...
		function (e) {
			...
			form.append( 'action', (window.cepcerto_ajax && window.cepcerto_ajax.action) || (window.CepCertoCalculator && window.CepCertoCalculator.action) || 'cepcerto_calculate_product_shipping' );
			form.append( 'nonce', (window.cepcerto_ajax && window.cepcerto_ajax.nonce) || (window.CepCertoCalculator && window.CepCertoCalculator.nonce) || '' );
			form.append( 'product_id', productId || '' );
			form.append( 'postcode', cep );

			fetch(
				(window.cepcerto_ajax && window.cepcerto_ajax.ajax_url) || (window.CepCertoCalculator && window.CepCertoCalculator.ajaxUrl) || '/wp-admin/admin-ajax.php',
				{
					method: 'POST',
